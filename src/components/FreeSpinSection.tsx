...
const SlotWheel: React.FC = () => {
  // simple "slot reel" illusion (no images needed)
  return (
        ...
        <div className="px-6 pb-6">
          <div className="grid grid-cols-3 gap-3">
            {["🧧", "🍊", "💰"].map((emoji, idx) => (
              ...
              >
                ...
                <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-[42px] bg-yellow-400/10 border-y border-yellow-400/30 pointer-events-none" />
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            >
              ...
              <div className="absolute -right-6 top-1/2 -translate-y-1/2 w-10 h-2 rounded-full bg-yellow-300/70 blur-[1px]" />
            </motion.div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-white/80 font-bold text-sm md:text-base max-w-2xl mx-auto">
            Spin on <span className="text-yellow-200">selected slot games</span> only.
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <div className="mt-2 text-white text-3xl md:text-4xl font-black tracking-tight">
                  RM50 Deposit
                </div>
              </div>
            ...
            <div className="mt-8 grid gap-4">
              {[
                ...
                >
                  <div className="mt-1 w-2.5 h-2.5 rounded-full bg-yellow-300 shadow-[0_0_16px_rgba(250,204,21,0.8)]" />
                  <p className="text-white/85 font-bold text-sm leading-relaxed">
                    {t}
                  </p>
                </div>
              ))}
        ...
        <div className="mt-10 text-center">
          <p className="text-white/35 text-[10px] font-black uppercase tracking-[0.35em]">
            Terms apply • Selected games list may change without notice
          </p>
        </div>
      </div>
    </section>
